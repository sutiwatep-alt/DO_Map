...
self.addEventListener('fetch', (e) => {
  ...
  if (/(firestore\.googleapis\.com|firebaseinstallations|identitytoolkit|firebaseremoteconfig|\.firebaseio\.com|google-analytics)/.test(url.href)) {
    return;
  }
